            ...
            <div class="card shadow-sm">
                <div class="card-header bg-transparent py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 text-dark">
                            <i class="fas fa-user-graduate me-2"></i>Edit Student
                        </h5>
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('teacher.students.update', $student->id) }}">
                        ...
                        <div class="mb-3">
                            <label for="name"
                                class="form-label text-muted small text-uppercase fw-semibold">Name</label>
                        ...
                        <div class="mb-3">
                            <label for="email"
                                class="form-label text-muted small text-uppercase fw-semibold">Email</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">
                        ...
                        <div class="mb-3">
                            <label for="password"
                                class="form-label text-muted small text-uppercase fw-semibold">Password</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">
                        ...
                        <div class="mb-3">
                            <label for="phone"
                                class="form-label text-muted small text-uppercase fw-semibold">Phone</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">
                        ...
                        <div class="mb-3">
                            <label for="class"
                                class="form-label text-muted small text-uppercase fw-semibold">Class</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <textarea id="bio"
                                    ...
                                    name="bio" rows="3">{{ old('bio', $student->bio) }}</textarea>
                            </div>
                            @error('bio')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
