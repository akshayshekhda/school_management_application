<!-- resources/views/teacher/announcements/edit.blade.php -->
@extends('layouts.app')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted small mb-0">Update announcement details</p>
                        </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('teacher.announcements.update', $announcement) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-9">
                                <select id="target" 
                                    ...
                                    <option value="both" {{ old('target', $announcement->target) === 'both' ? 'selected' : '' }}>
