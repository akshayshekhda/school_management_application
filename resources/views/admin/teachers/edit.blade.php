        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fas fa-user-edit me-2"></i>{{ __('Edit Teacher') }}</h4>
                </div>
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.teachers.update', $teacher->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" 
                                    name="name" value="{{ old('name', $teacher->name) }}" required autocomplete="name" autofocus
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" 
                                    name="email" value="{{ old('email', $teacher->email) }}" required autocomplete="email"
                        ...
                        <div class="section-header mb-4 mt-5">
                            ...
                            <small class="text-muted">Leave password fields empty to keep the current password.</small>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                ...
                                <small class="form-text text-muted">Leave blank to keep current password. New password must be at least 6 characters.</small>
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-3 col-form-label">
                                <i class="fas fa-lock me-2"></i>{{ __('Confirm New Password') }}
                            </label>
                            <div class="col-md-9">
                                <div class="input-group">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input id="subject" type="text" class="form-control @error('subject') is-invalid @enderror" 
                                    name="subject" value="{{ old('subject', $teacher->subject) }}" required
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea id="bio" class="form-control @error('bio') is-invalid @enderror" 
                                    ...
                                    placeholder="Enter professional biography">{{ old('bio', $teacher->bio) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-9 offset-md-3">
                                <button type="submit" class="btn btn-primary px-4">
                                    <i class="fas fa-save me-2"></i>{{ __('Update Teacher') }}
                                </button>
